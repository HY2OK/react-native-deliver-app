      ...
      <ScrollView>
        ...
        <View className="relative">
          <Image
            ...
            className="w-full h-56 p-4 bg-gra300"
          />
          ...
          <View className="bg-white">
            <View className="px-4 pt-4">
              ...
              <Text className="pb-4 mt-2 text-gray-500">{shortDescription}</Text>
            </View>

            <TouchableOpacity className="flex-row items-center p-3 space-x-2 border-gray-300 border-y">
